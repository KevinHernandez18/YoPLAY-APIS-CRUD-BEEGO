...
func (c *GrupoController) GetOne() {
	...
	if err != nil {
		logs.Error(err)
		c.Data["json"] = map[string]interface{}{"success":false, "status": 404, "Message":"Grupo no encontrado"}
	} else {
...
func (c *GrupoController) Put() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateGrupoById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success":true, "status": 200, "Message":"Grupo actualizado exitosamente", "Data":v}
		} else {
			c.Data["json"] = err.Error()
		}
	} else {
...
func (c *GrupoController) Delete() {
	...
	if err := models.DeleteGrupo(id); err == nil {
		c.Data["json"] = map[string]interface{}{"success":true, "status": 200, "Message":"Grupo eliminado exitosamente", "Data": id}
	} else {
		c.Data["json"] = err.Error()
	}
	c.ServeJSON()
