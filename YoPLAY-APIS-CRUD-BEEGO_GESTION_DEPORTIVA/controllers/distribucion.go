...
// DistribucionController operations for Distribucion
type DistribucionController struct {
	beego.Controller
}

// URLMapping ...
func (c *DistribucionController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Distribucion
// @Param	body		body 	models.Distribucion	true		"body for Distribucion content"
// @Success 201 {int} models.Distribucion
// @Failure 403 body is empty
// @router / [post]
func (c *DistribucionController) Post() {
	var v models.Distribucion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddDistribucion(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Distribucion by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Distribucion
// @Failure 403 :id is empty
// @router /:id [get]
func (c *DistribucionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetDistribucionById(id)
	if err != nil {
...
// @Failure 403
// @router / [get]
func (c *DistribucionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllDistribucion(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// Put ...
// @Title Put
// @Description update the Distribucion
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Distribucion	true		"body for Distribucion content"
// @Success 200 {object} models.Distribucion
// @Failure 403 :id is not int
// @router /:id [put]
func (c *DistribucionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Distribucion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateDistribucionById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "message": "Peticion existosa", "Data": v}
		} else {
...
// Delete ...
// @Title Delete
// @Description delete the Distribucion
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *DistribucionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteDistribucion(id); err == nil {
