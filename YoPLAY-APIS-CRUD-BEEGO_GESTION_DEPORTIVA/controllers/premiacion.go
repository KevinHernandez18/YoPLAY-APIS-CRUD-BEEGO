...
// PremiacionController operations for Premiacion
type PremiacionController struct {
	beego.Controller
}

// URLMapping ...
func (c *PremiacionController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Premiacion
// @Param	body		body 	models.Premiacion	true		"body for Premiacion content"
// @Success 201 {int} models.Premiacion
// @Failure 403 body is empty
// @router / [post]
func (c *PremiacionController) Post() {
	var v models.Premiacion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddPremiacion(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Premiacion by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Premiacion
// @Failure 403 :id is empty
// @router /:id [get]
func (c *PremiacionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetPremiacionById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *PremiacionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllPremiacion(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// Put ...
// @Title Put
// @Description update the Premiacion
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Premiacion	true		"body for Premiacion content"
// @Success 200 {object} models.Premiacion
// @Failure 403 :id is not int
// @router /:id [put]
func (c *PremiacionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Premiacion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdatePremiacionById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "message": "Peticion existosa", "Data": v}
		} else {
...
// Delete ...
// @Title Delete
// @Description delete the Premiacion
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *PremiacionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeletePremiacion(id); err == nil {
