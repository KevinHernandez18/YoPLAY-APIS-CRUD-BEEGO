...
// TorneoController operations for Torneo
type TorneoController struct {
	beego.Controller
}

// URLMapping ...
func (c *TorneoController) URLMapping() {
...
// @Success 201 {int} models.Torneo
// @Failure 403 body is empty
// @router / [post]
func (c *TorneoController) Post() {
	var v models.Torneo
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTorneo(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Torneo by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Torneo
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TorneoController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTorneoById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *TorneoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTorneo(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// @router /:id [put]
func (c *TorneoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Torneo{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTorneoById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "message": "Peticion existosa", "Data": v}
		} else {
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *TorneoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTorneo(id); err == nil {
