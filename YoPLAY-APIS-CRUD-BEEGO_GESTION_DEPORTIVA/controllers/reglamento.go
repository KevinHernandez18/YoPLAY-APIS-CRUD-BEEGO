...
// ReglamentoController operations for Reglamento
type ReglamentoController struct {
	beego.Controller
}

// URLMapping ...
func (c *ReglamentoController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Reglamento
// @Param	body		body 	models.Reglamento	true		"body for Reglamento content"
// @Success 201 {int} models.Reglamento
// @Failure 403 body is empty
// @router / [post]
func (c *ReglamentoController) Post() {
	var v models.Reglamento
...
// GetOne ...
// @Title Get One
// @Description get Reglamento by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Reglamento
// @Failure 403 :id is empty
// @router /:id [get]
func (c *ReglamentoController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *ReglamentoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllReglamento(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// Put ...
// @Title Put
// @Description update the Reglamento
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Reglamento	true		"body for Reglamento content"
// @Success 200 {object} models.Reglamento
// @Failure 403 :id is not int
// @router /:id [put]
func (c *ReglamentoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// Delete ...
// @Title Delete
// @Description delete the Reglamento
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ReglamentoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
