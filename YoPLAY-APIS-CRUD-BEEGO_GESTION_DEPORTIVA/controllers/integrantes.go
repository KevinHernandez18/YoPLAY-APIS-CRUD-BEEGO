...
// IntegrantesController operations for Integrantes
...
// Post ...
// @Title Post
// @Description create Integrantes
// @Param	body		body 	models.Integrantes	true		"body for Integrantes content"
// @Success 201 {int} models.Integrantes
// @Failure 403 body is empty
// @router / [post]
func (c *IntegrantesController) Post() {
	var v models.Integrantes
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddIntegrantes(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Integrantes by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Integrantes
// @Failure 403 :id is empty
// @router /:id [get]
func (c *IntegrantesController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetIntegrantesById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *IntegrantesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllIntegrantes(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// Put ...
// @Title Put
// @Description update the Integrantes
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Integrantes	true		"body for Integrantes content"
// @Success 200 {object} models.Integrantes
// @Failure 403 :id is not int
// @router /:id [put]
func (c *IntegrantesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Integrantes{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateIntegrantesById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "message": "Peticion existosa", "Data": v}
		} else {
...
// Delete ...
// @Title Delete
// @Description delete the Integrantes
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *IntegrantesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteIntegrantes(id); err == nil {
