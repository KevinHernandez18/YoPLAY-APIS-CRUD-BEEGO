...
// TipoDeporteController operations for TipoDeporte
type TipoDeporteController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoDeporteController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create TipoDeporte
// @Param	body		body 	models.TipoDeporte	true		"body for TipoDeporte content"
// @Success 201 {int} models.TipoDeporte
// @Failure 403 body is empty
// @router / [post]
func (c *TipoDeporteController) Post() {
	var v models.TipoDeporte
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoDeporte(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get TipoDeporte by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.TipoDeporte
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TipoDeporteController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoDeporteById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *TipoDeporteController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoDeporte(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// Put ...
// @Title Put
// @Description update the TipoDeporte
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.TipoDeporte	true		"body for TipoDeporte content"
// @Success 200 {object} models.TipoDeporte
// @Failure 403 :id is not int
// @router /:id [put]
func (c *TipoDeporteController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoDeporte{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoDeporteById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "message": "Peticion existosa", "Data": v}
		} else {
...
// Delete ...
// @Title Delete
// @Description delete the TipoDeporte
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *TipoDeporteController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoDeporte(id); err == nil {
