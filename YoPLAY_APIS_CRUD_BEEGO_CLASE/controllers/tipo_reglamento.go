...
// TipoReglamentoController operations for TipoReglamento
type TipoReglamentoController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoReglamentoController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create TipoReglamento
// @Param	body		body 	models.TipoReglamento	true		"body for TipoReglamento content"
// @Success 201 {int} models.TipoReglamento
// @Failure 403 body is empty
// @router / [post]
func (c *TipoReglamentoController) Post() {
	var v models.TipoReglamento
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoReglamento(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get TipoReglamento by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.TipoReglamento
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TipoReglamentoController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoReglamentoById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
// @Title Get All
// @Description get TipoReglamento
...
// @Failure 403
// @router / [get]
func (c *TipoReglamentoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoReglamento(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// Put ...
// @Title Put
// @Description update the TipoReglamento
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.TipoReglamento	true		"body for TipoReglamento content"
// @Success 200 {object} models.TipoReglamento
// @Failure 403 :id is not int
// @router /:id [put]
func (c *TipoReglamentoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoReglamento{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoReglamentoById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "message": "Peticion existosa", "Data": v}
		} else {
...
// Delete ...
// @Title Delete
// @Description delete the TipoReglamento
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *TipoReglamentoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoReglamento(id); err == nil {
