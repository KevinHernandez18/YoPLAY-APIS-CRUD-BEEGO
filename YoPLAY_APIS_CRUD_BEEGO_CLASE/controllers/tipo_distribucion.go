...
// TipoDistribucionController operations for TipoDistribucion
type TipoDistribucionController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoDistribucionController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create TipoDistribucion
// @Param	body		body 	models.TipoDistribucion	true		"body for TipoDistribucion content"
// @Success 201 {int} models.TipoDistribucion
// @Failure 403 body is empty
// @router / [post]
func (c *TipoDistribucionController) Post() {
	var v models.TipoDistribucion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoDistribucion(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get TipoDistribucion by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.TipoDistribucion
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TipoDistribucionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoDistribucionById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
// @Title Get All
// @Description get TipoDistribucion
...
// @Failure 403
// @router / [get]
func (c *TipoDistribucionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoDistribucion(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		if l == nil {
...
// Put ...
// @Title Put
// @Description update the TipoDistribucion
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.TipoDistribucion	true		"body for TipoDistribucion content"
// @Success 200 {object} models.TipoDistribucion
// @Failure 403 :id is not int
// @router /:id [put]
func (c *TipoDistribucionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoDistribucion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoDistribucionById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "message": "Peticion existosa", "Data": v}
		} else {
...
// Delete ...
// @Title Delete
// @Description delete the TipoDistribucion
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *TipoDistribucionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoDistribucion(id); err == nil {
